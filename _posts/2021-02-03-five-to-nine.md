...
But still everyone insisted on the comparison. This is a fairly familiar hype phenomenon that surrounds VR in general. There seems to be a massive collective investment in VR being some kind of breakthrough which will open up new vistas of experience, when in truth a lot of the time it's just like having a screen that goes all the way round. (OK---there is some other differences, but no way is the degree of hype matched by the profundity of the experience.)

But while the VR app was in no way a substitute for a DMT experience, it did have something that DMT does not: the experience is shared, in the sense that everybody experiences the same thing. It has a dimension of common knowledge that can never be present for DMT trips. DMT trips are both awe inspiring and private, things you go through alone and then might struggle to convey to other people in terms they understand. This can be weird, disorienting, and hard work.
