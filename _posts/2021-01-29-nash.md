...
Indeed we might wonder: how many domains of preference beyond those pertaining to basic material needs are _not_ shot through with social significance? If we are the kind of creatures for whom MPD is the rule rather than the exception, then we should expect the engineering and exploitation of bad Nash equilibria  not to be edge cases, but one of the Invisible Hand's common plays. Our free will cannot not help us, and what was supposed to be a loving God turns out to look suspiciously like Moloch.
