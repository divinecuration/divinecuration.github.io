...
**4.4. Qualification.** It must be assumed that the effect of structure be complete, and the count-of-one does not encounter singular islands ‘forgotten’ by presentation (the logic of the lacuna, or lack). The nothing is never be localised within a structured presentation (i.e. the nothing is neither a term nor a position in the structure).
